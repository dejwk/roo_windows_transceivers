...
DescriptorWidget::DescriptorWidget(roo_windows::ApplicationContext& env)
    : roo_windows::VerticalLayout(env),
      sensors_caption_(env, "Sensors", roo_windows::material2::text_style_caption()),
      sensors_{
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
      ...
      actuators_caption_(env, "Actuators", roo_windows::material2::text_style_caption()),
      actuators_{
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
          roo_windows::TextLabel(env, "", roo_windows::material2::text_style_body1()),
